  ...
  return (
    <section className='pb-28 max-md:pb-28'>
        <div className={`${styles.boxWidth} ${styles.paddingX} ${styles.flexCenter} flex justify-center items-center flex-col m-auto`}>
            <div className="mb-20 after:w-8 after:h-px after:bg-dimLightGrey after:block before:w-8 before:h-px before:bg-dimLightGrey before:block flex flex-row items-center justify-center gap-4">
